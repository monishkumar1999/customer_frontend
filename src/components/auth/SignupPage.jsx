            ...
            <div className="w-full lg:w-1/2 flex flex-col relative bg-white overflow-y-auto">
                ...
                <header className="w-full px-8 py-6 flex justify-between items-center relative z-20">
                    ...
                    <div className="hidden sm:block text-sm font-medium">
                        ...
                        <a className="text-[#137fec] hover:text-[#0b63c1] ml-1 font-semibold transition-colors cursor-pointer" onClick={() => navigate('/login')}>Log In</a>
                    </div>
                </header>
                ...
                <div className="flex-1 flex flex-col justify-center items-center px-6 sm:px-12 relative z-10">
                    <div className="w-full max-w-[440px] space-y-8">
                        <div className="text-center sm:text-left">
                            <h2 className="font-display text-3xl font-bold text-slate-900 mb-2">Create an account</h2>
                        ...
                        <form className="space-y-5" onSubmit={handleSignup}>
                            <div className="space-y-1.5">
                                ...
                                <div className="relative group">
                                    <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#137fec] transition-colors">person</span>
                                    <input
                        ...
                        <div className="sm:hidden text-center text-sm font-medium">
                            <span className="text-slate-500">Already have an account?</span>
                            <a className="text-[#137fec] hover:text-[#0b63c1] ml-1 font-bold cursor-pointer" onClick={() => navigate('/login')}>Log In</a>
                        </div>
                    </div>
                </div>
